          ...
          return (
            <div>
              <div className="react-slick-continer">
                <div>
                  <Slider {...settings} className="react-slick-continer">
                    {topReadBooksList.map(each => (
                      ...
                      >
                        ...
                        >
                          ...
                          <h1 className="home-authorName">{each.title}</h1>
                          <p className="home-slick-title">{each.authorName}</p>
                        </li>
                      </Link>
                    ))}
                  </Slider>
                    ...
                    {topReadBooksList.map(each => (
                      ...
                      >
                        ...
                        >
                          ...
                          <h1 className="home-authorName">{each.authorName}</h1>
                          <p className="home-slick-title">{each.title}</p>
                        </li>
                      </Link>
                    ))}
                  </Slider>
